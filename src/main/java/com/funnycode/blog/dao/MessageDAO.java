...
public interface MessageDAO {
    ...
    List<Message> findLimitByConversationId(@Param("conversationId") String conversationId,
    ...
    List<Message> findPreviouslyByConversationId(@Param("conversationId") String conversationId,
                                        @Param("offset") int offset,
                                        @Param("limit") int limit,
    ...
    List<Message> findNewestByConversationId(@Param("conversationId") String conversationId,
    ...
    List<Message> findAllConversationByUserId(@Param("userId") long userId,
                                      @Param("offset") int offset,
                                      @Param("limit") int limit);
    ...
    List<Message> findAllByUserIdAndType(@Param("userId") long userId,
                                    @Param("type") int type,
                                    @Param("offset") int offset,
                                    @Param("limit") int limit);
    ...
    int countUnreadByUserIdAndConversationId(@Param("userId") long userId, @Param("conversationId") String conversationId);
    ...
    int countUnreadByUserIdAndType(@Param("userId") long userId, @Param("type") int type);
    ...
    int updateHasreadByUserIdAndType(@Param("userId") long userId, @Param("type") int type);
    ...
    int updateHasreadByUserIdAndConversationId(@Param("conversationId")String conversationId,
