    ...
    function(t) {
     ...
     var e = layui.$,
         ...
         c = function() {
          ...
          t.index = 0,
              t.config = {
               tool: ["strong", "italic", "underline", "del", "|", "left", "center", "right", "|", "link", "unlink", "face", "image", "feedImage"],
               hideTool: [],
               height: 280,
               btn: ''
              }
         ...
         c.prototype.build = function(t, i) {
          ...
          var a = this,
              ...
              m = e(['<div class="' + r + '">',
                  ...
                  "</div>",
                  '<div class="layui-unselect layui-layedit-tool">' + f + y.btn + "</div>",
                  "</div>"].join(""));
     ...
     var s = function(t, i, a) {
         ...
         g = function(t, a, l) {
          var n = t.document,
              ...
              c = {
               ...
               feedImage: function(a) {
                   myImg.call(this, function(i) {})
               },
               code: function(e) {
                k.call(o,
                    function(i) {
         ...
         myImg = function(t) {
           feedImgTag ? i.close(myImg.index) : (myImg.index = i.tips(function() {
               return ["<div class='image-popup'>",
                   ...
                   "<div class='pics-content'>","<div class='upload-image-wrapper'>","<div class='upload-image'>",
                   "<input type='hidden' id='upload-file-array' class='upload-file-array'>","<div class='upload-list'>",
                   "<div class='upload-btn'>","<input type='file'  name='file' id='feedpic-upload-input' class='upload'>",
               ...
               success: function(l, n) {
                   feedImgTag = true;
                   let imgNum = 0, curFiles = [];  //图片数，图片路径列表
                   l.css({
                       marginTop: -4,
                       marginLeft: -10
                   }).find(".image-close-btn").on("click",
                       function() {
                           i.close(n);
                       });
                   layui.use("upload",
                       function(o) {
                           o.render({
                               ...
                               method: 'post',
                                   ...
                                   if(res.code === REQ_SUCC){
                                       console.log("上传成功");
                                       let uploadBtn = l.find(".upload-btn");
                                       if (res.data && res.data.src) {
                                           //预览图片
                                           let imgObjPreview = document.createElement("div"), //图片
                                               delPointer = document.createElement("span");  //删除图片按钮
                                           imgObjPreview.classList.add("success-wrapper");
                                           imgObjPreview.style.backgroundImage = "url("+ res.data.src +")";
                                           delPointer.classList.add("del-pointer");
                                           delPointer.innerHTML = "<svg class='icon del-pointer-icon' aria-hidden='true'><use xlink:href='#icon-guanbi'></use></svg>";
                                           let newImg = document.createElement("div");    //添加图片预览
                                           newImg.classList.add("upload-status");
                                           newImg.appendChild(imgObjPreview);
                                           newImg.appendChild(delPointer);
                                           uploadBtn.before(newImg);   //插入图片
                                           //注册“移除图片”事件
                                           delPointer.addEventListener("click", function (e) {
                                               curFiles = curFiles.filter(function (src) {
                                                   return src !== res.data.src;
                                               });
                                               newImg.remove();
                                               imgNum--;
         ...
         C = {
          ...
          feedImage: '<i class="layui-icon layedit-tool-image" title="动态图片" layedit-event="feedImage">&#xe64a;</i>'
         },
         w = new c;
     t(n, w)
    });