layui.use(['layer'], function () {
    ...
    getQuestionType();
    $("#question-type").mousedown(getQuestionType);
    ...
    function getQuestionType(){
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "/user/question/type",
            success : function(data){
                let select = document.querySelector("#question-type");
